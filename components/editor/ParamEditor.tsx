...
const fields: Array<{
  ...
  { key: "W", label: "Ancho (cm)", min: 40, max: 300, step: 1 },
  { key: "H", label: "Alto (cm)", min: 40, max: 300, step: 1 },
  { key: "D", label: "Profundidad (cm)", min: 20, max: 80, step: 1 },
  { key: "thickness", label: "Espesor (cm)", min: 1.5, max: 3, step: 0.1 },
